...
<div id="wp-notification" class="closed">
	<div class="wp-notification-container">
		<p>This website uses cookies to enhance your browsing experience... <a href="<?= site_url($url) ?>/">More information</a><span id="wp-notification-toggle">I understand</span></p>
	</div>
</div>